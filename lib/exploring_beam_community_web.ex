defmodule ExploringBeamCommunityWeb do
  @moduledoc """
  ...
  def static_paths, do: ~w(assets fonts images favicon.ico robots.txt pdf)
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {ExploringBeamCommunityWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        statics: ExploringBeamCommunityWeb.static_paths()
    end
  end
