...
config :exploring_beam_community, ExploringBeamCommunityWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "SUSa3ogZ4uPZLlu8fSzu8o4o3D/Broj8VJBYrTZUs546lbR3xQDgPUuCDWakXZzz",
  watchers: [
...
config :exploring_beam_community, ExploringBeamCommunityWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"lib/exploring_beam_community_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]
